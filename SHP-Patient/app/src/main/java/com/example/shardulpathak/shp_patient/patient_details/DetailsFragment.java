        ...
        mEditButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (v instanceof Button) {
                    if (((Button) v).getText().equals(getString(R.string.edit_details_edit_btn_text))) {
                        makeViewEditable();
                    } else if (((Button) v).getText().equals(getString(R.string.edit_details_submit_btn_text))) {
                        getUpdatedValues();
                        sendValuesToServer();
                        makeViewNotEditable();//retain updated info
                    }
                }
//                if (mIsEditing) {
//                    sendValuesToServer();
...
//                }
        ...
        mCancelButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                makeViewNotEditable();//retain original(previous) values.
            }
        });
    }
    ...
    public class EditDetailsTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                String editDetailsURL = "http://skillab.in/medical_beta/catalog/user/user_patient_register_api_edit";
