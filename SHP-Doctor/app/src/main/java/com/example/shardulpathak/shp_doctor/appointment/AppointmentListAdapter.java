...
public class AppointmentListAdapter extends BaseAdapter {
    ...
    public AppointmentListAdapter(Context context, List<Appointment> appointmentList, MyAppointmentsFragment myAppointmentsFragment) {
        this.mContext = context;
        this.mAppointmentList = appointmentList;
        this.mAppointmentsFragment = myAppointmentsFragment;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.mAppointmentDateView = (EditText) convertView.findViewById(R.id.appointment_date);

            holder.mAppointmentDateView.setOnFocusChangeListener(new View.OnFocusChangeListener() {
                @Override
                public void onFocusChange(View v, boolean hasFocus) {
                    if (hasFocus) {
                        final EditText dateEditText = (EditText) v;
                        mAppointmentDate = dateEditText.getText().toString();
                    }
                }
            });
            holder.mAppointmentTimeView = (EditText) convertView.findViewById(R.id.appointment_time);
            holder.mAppointmentTimeView.setOnFocusChangeListener(new View.OnFocusChangeListener() {
                @Override
                public void onFocusChange(View v, boolean hasFocus) {
                    if (hasFocus) {
                        final EditText timeEditText = (EditText) v;
                        mAppointmentTime = timeEditText.getText().toString();
                    }
                }
            });
            ...
            acceptButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    mAppointmentsFragment.sendDoctorResponse(true, holder.mAppointmentIDView.getText().toString(), mAppointmentDate, mAppointmentTime);
                }
            });
            ...
            denyButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    String appointmentDate = holder.mAppointmentDateView.getText().toString();
                    String appointmentTime = holder.mAppointmentTimeView.getText().toString();
                    if (mAppointmentList.size() != position) {
                        mAppointmentList.remove(mAppointmentList.get(position));
                    }
                    mAppointmentsFragment.sendDoctorResponse(false, holder.mAppointmentIDView.getText().toString(), appointmentDate, appointmentTime);
                }
            });
