...
import com.example.shardulpathak.shp_doctor.DummyContent.DummyItem;
...
public class NotificationRecyclerViewAdapter extends RecyclerView.Adapter<NotificationRecyclerViewAdapter.ViewHolder> {
    ...
    public NotificationRecyclerViewAdapter(List<DummyItem> items, IFragmentCommunicator listener) {
        mValues = items;
        mListener = listener;
    }
